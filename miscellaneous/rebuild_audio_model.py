...
INPUT_WIDTH = 157
INPUT_CHANNELS = 1
MODEL_WEIGHTS_PATH = "models/audio_model_alcj_weights.pkl"  # Saved weights from my model built in TF 2.10
RESAVED_MODEL_PATH = "models/audio_model_tf217_alcj.keras" # Rebuilt model compatible with current project
